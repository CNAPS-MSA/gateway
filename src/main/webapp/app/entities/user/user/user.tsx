...
export const User = (props: IUserProps) => {
  ...
  return (
    <div>
      <h2 id="user-heading">
        <Translate contentKey="gatewayApp.userUser.home.title">Users</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gatewayApp.userUser.home.createLabel">Create new User</Translate>
        </Link>
      </h2>
        ...
        {userList && userList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="gatewayApp.userUser.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${user.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${user.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.userUser.home.notFound">No Users found</Translate>
            </div>
          )
        )}
      </div>
